...
#the manual version of the copycat



# keeps track of players to not use specifically
totalToSpit = int(input("how many line ups to spit out . . . "))
name_of_csv = str(input("what do you want to call your file, no spaces . . . . . ."))


# the names that go into the list should be rg_names 
blacklist = list()

user_input = "please type in players you do not want to include, start to end"
print(user_input)

# the lower case is to prevent the problem with LeBron Lebron
while (True):
    user_input = str(input("who to blacklist?......")).lower()
    if (user_input == "start"):
        break
    blacklist.append(user_input)

print("blacklisting , , , , , , , ")
for person in blacklist:
    print(person)
print("Total lineups to output : ",totalToSpit)
